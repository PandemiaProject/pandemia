...
This *bottom-up* approach contrasts with the *top-down* equation-based approach to epidemic
modelling, an example of the latter being the SIR model.
...
is a generalization of the ABMlux model.
