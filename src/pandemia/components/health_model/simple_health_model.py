...
class SimpleHealthModel(HealthModel):
    ...
    def __init__(self, config, scale_factor, clock, enable_ctypes):
        ...
        self.divide_multipliers =\
            config['divide_location_multipliers_by_number_of_agents_in_region']
        ...
        self._get_presets(clock.ticks_in_day)
    ...
    def initial_conditions_c(self, vector_region):
        ...
        for m in range(vector_region.number_of_locations):
            ...
            if self.divide_multipliers:
                vector_region.location_transmission_multiplier[m] /= vector_region.number_of_agents
