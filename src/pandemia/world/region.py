...
class VectorRegion:
    ...
    random_state : np.ndarray
        A pair of 64-bit integers. This pair is the random seed to be used by the prng
        inside the C libraries. This is an numpy array of length 2, consisting of two integers of
        type np.uint64. Each region gets it own random state, to preserve determinism when
        parallelizing.
    prng : Random
